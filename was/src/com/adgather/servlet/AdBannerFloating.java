...
public class AdBannerFloating extends HttpServlet {
	private DumpObject dumpObj;
	private ApplicationContext appContext;
	public ManagementCookie manageCookie;
	private RFServlet servlet;
	static Logger logger = Logger.getLogger(AdBannerFloating.class);
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		int debug=0;
		try {
			logger.info("AdBannerFloating.java start");
			...
			logger.info("type ="+types+" igb ="+igb);
			
			if( igb.equals("7") ){
				txt_file= FileUtil.readFile("/home/dreamsearch/public_html/ad/adBanner_edge.js");
				if( txt_file.equals("") ){
					txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/ad/adBanner_edge.js");
				}
				...
				txt_file= FileUtil.readFile("/home/dreamsearch/public_html/ad/adBanner_video.js");
				//logger.debug("adbnfloating[90] "+txt_file);
				if( txt_file.equals("") ){
					txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/ad/adBanner_video.js");
				}
				txt_file= txt_file.replace("{{ad_t}}",t);
				txt_file= txt_file.replace("{{ad_align}}",align);
				txt_file= txt_file.replace("{{ad_w}}",w);
				...
				txt_file= txt_file.replace("{{ad_tag}}", "<iframe name='ifrad' id='ifrad' width='"+w+"' height='"+h+"' "
						+" src='http://www.dreamsearch.or.kr/servlet/adBanner?from=\"+escape(from)+\"&u="+u+"&pCode="+pCode+"&us="+us+"&s="+s+"&iwh="+iwh+"&igb="+igb+"&types=video' "
				...
				txt_file= FileUtil.readFile("/home/dreamsearch/public_html/ad/adBanner_mobile.js");
				if( txt_file.equals("") ){
					txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/ad/adBanner_mobile.js");
				}
				if( !cntsr.equals("") ){
					txt_file= FileUtil.readFile("/home/dreamsearch/public_html/ad/adBanner_mobile1.js");
					if( txt_file.equals("") ){
						txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/ad/adBanner_mobile1.js");
					}
				}
				...
				txt_file= FileUtil.readFile("/home/dreamsearch/public_html/ad/adBanner_floating.js");
				if( txt_file.equals("") ){
					txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/ad/adBanner_floating.js");
				}
	...
	public void init() throws ServletException {
		logger.info("AdBannerFloating started");
		if (appContext == null) {
