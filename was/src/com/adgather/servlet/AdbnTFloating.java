...
public class AdbnTFloating extends HttpServlet {
	private DumpObject dumpObj;
	private ApplicationContext appContext;
	public ManagementCookie manageCookie;
	private RFServlet servlet;
	static Logger logger = Logger.getLogger(AdbnTFloating.class);
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if( igb.equals("7") ){
				...
				logger.info("============ tost Start .......... ============");
				txt_file= FileUtil.readFile("/home/dreamsearch/public_html/ad/adbn_tfloating.js");
				if( txt_file.equals("") ){
					txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/ad/adbn_tfloating.js");
				}
