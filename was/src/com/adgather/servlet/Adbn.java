...
public class Adbn extends HttpServlet {
	private DumpObject dumpObj;
	private ApplicationContext appContext;
	public ManagementCookie manageCookie;
	static Logger logger = Logger.getLogger(Adbn.class);
					...
					if( shop_log!=null && shop_log.length()>0 ) {
						...
						if( igb.equals("2") || igb.equals("3") && scfg!=null && scfg.getStateW().equals("Y") ) { 
							...
							if( rList.size()>0 && ms.getAccept_sr().equals("Y") && scfg!=null && scfg.getStateW().equals("Y") ){
								...
								String resultvalue=manageCookie.makeCookieStrNew(response, request, chk_result, chk_ck, chk_code, 20, chk);
			...
			if( !chk.equals("") ){
				...
				if( !partner_uid.equals("") && list.contains(partner_uid) ){
					...
					if( scfg==null ){
						...
						//http://www.dreamsearch.or.kr/servlet/adbn?from=&u={u}&us={us}&s={s}&iwh={iwh}&igb={igb}&psb=99&clk_param=
...
//			}
			...
			debug="a-8-11-1";
			if( types.equals("flash") || types.equals("video") || igb.equals("6") || igb.equals("4") 
				...
				if( adgubun.equals("SR") || adgubun.equals("ST") ){
					...
					html_flash.append("{\"t0\":\"\",\"pcode\":\""+scfg.getPcode()
							...
							+"\",\"purl\":\""+ r_purl +"\",\"logo\":\""+ scfg.getImgname_logo() +"\"}");
