...
public class AdbnFloating2 extends HttpServlet {
	private DumpObject dumpObj;
	private ApplicationContext appContext;
	public ManagementCookie manageCookie;
	private RFServlet servlet;
	static Logger logger = Logger.getLogger(AdbnFloating2.class);
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		int debug=0;
		try {
			logger.info("AdbnFloating2.java start");
...
//				//logger.info("adbnfloating[90] "+txt_file);
//				if( txt_file.equals("") ){
...
//				}
				...
				logger.info("bntype="+bntype+", cntsr="+cntsr+", cntad="+cntad+", imgtype="+imgtype);
				logger.info("cntsr="+cntsr);
				
				txt_file= FileUtil.readFile("/home/dreamsearch/public_html/newAd/adbn_mobileBanner.js");
				if( txt_file.equals("") ){
					txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/newAd/adbn_mobileBanner.js");
				}
			/*	txt_file=(String) RFServlet.instance.xml.get("adbn_mobile_js");
				...
				if( !cntsr.equals("") ){
					txt_file= FileUtil.readFile("/home/dreamsearch/public_html/newAd/adbn_mobileBanner1.js");
					if( txt_file.equals("") ){
						txt_file= FileUtil.readFile("D:/work/enliple/www/webapp/public_html/newAd/adbn_mobileBanner1.js");
					}
...
//				}
	...
	public void init() throws ServletException {
		logger.info("AdbnFloating2Servlet started");
		if (appContext == null) {
